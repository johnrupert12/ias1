...
<body>
    <main>
    <nav class="navbar navbar-expand-lg navbar-light bg-light bg-gradient" id="topNavBar">
        <div class="container">
        <h1 class="navbar-brand" href="#">
           STUDENT GRADING SYSTEM
    </h1>
    </nav>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark bg-gradient" id="top1NavBar">
        <div class="container">
<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'class')? 'active' : '' ?>" href="./?page=class">Class</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'students')? 'active' : '' ?>" aria-current="page" href="./?page=students">Students</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'assessments')? 'active' : '' ?>" aria-current="page" href="./?page=assessments">Assessments</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'marks')? 'active' : '' ?>" aria-current="page" href="./?page=marks">Marks</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'reports')? 'active' : '' ?>" aria-current="page" href="./?page=reports">Report</a>
                    </li>
                    <li class="nav-item">
